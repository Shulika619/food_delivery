...
abstract class $CategoryCopyWith<$Res> {
  ...
  $Res call({String? categoryId, String? categoryImage, String? categoryName});
}
...
class _$_Category implements _Category {
  _$_Category({this.categoryId, this.categoryImage, this.categoryName});
  ...
  @override
  String toString() {
    return 'Category(categoryId: $categoryId, categoryImage: $categoryImage, categoryName: $categoryName)';
  }
...
abstract class _Category implements Category {
  factory _Category(
      {final String? categoryId,
      final String? categoryImage,
      final String? categoryName}) = _$_Category;
